...
| 📝 **SQL Queries**                     | Data extraction, joins, aggregations |
...
✔️ Performing multi-table joins
✔️ Extracting insights using aggregations & window functions
✔️ Understanding customer behavior through SQL
